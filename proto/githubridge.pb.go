...
var file_githubridge_proto_rawDesc = []byte{
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x73, 0x68, 0x61, 0x31, 0x2a, 0x53, 0x0a, 0x0a,
	...
	0x02, 0x32, 0xdd, 0x08, 0x0a, 0x12, 0x47, 0x69, 0x74, 0x68, 0x75, 0x62, 0x72, 0x69, 0x64, 0x67,
...
var file_githubridge_proto_msgTypes = make([]protoimpl.MessageInfo, 32)
...
var file_githubridge_proto_depIdxs = []int32{
	...
	18, // 19: githubridge.GithubridgeService.AddLabel:output_type -> githubridge.AddLabelResponse
	20, // 20: githubridge.GithubridgeService.DeleteLabel:output_type -> githubridge.DeleteLabelResponse
	3,  // 21: githubridge.GithubridgeService.CreateIssue:output_type -> githubridge.CreateIssueResponse
	7,  // 22: githubridge.GithubridgeService.GetIssue:output_type -> githubridge.GetIssueResponse
	6,  // 23: githubridge.GithubridgeService.GetIssues:output_type -> githubridge.GetIssuesResponse
	9,  // 24: githubridge.GithubridgeService.CloseIssue:output_type -> githubridge.CloseIssueResponse
	11, // 25: githubridge.GithubridgeService.CommentOnIssue:output_type -> githubridge.CommentOnIssueResponse
	14, // 26: githubridge.GithubridgeService.GetComments:output_type -> githubridge.GetCommentsResponse
	16, // 27: githubridge.GithubridgeService.GetLabels:output_type -> githubridge.GetLabelsResponse
	23, // 28: githubridge.GithubridgeService.GetReleases:output_type -> githubridge.GetReleasesResponse
	25, // 29: githubridge.GithubridgeService.GetRepos:output_type -> githubridge.GetReposResponse
	27, // 30: githubridge.GithubridgeService.GetProjects:output_type -> githubridge.GetProjectsResponse
	30, // 31: githubridge.GithubridgeService.ListFiles:output_type -> githubridge.ListFilesResponse
	32, // 32: githubridge.GithubridgeService.GetRepo:output_type -> githubridge.GetRepoResponse
