...
func (x *ListFilesResponse) GetFile() []string {
	if x != nil {
		return x.File
	}
	return nil
...
var file_githubridge_proto_rawDesc = []byte{
	...
	0x04, 0x70, 0x61, 0x74, 0x68, 0x22, 0x27, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74, 0x46, 0x69, 0x6c,
	0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x66, 0x69,
	0x6c, 0x65, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x04, 0x66, 0x69, 0x6c, 0x65, 0x2a, 0x53,
	...
	0x44, 0x10, 0x02, 0x32, 0x97, 0x08, 0x0a, 0x12, 0x47, 0x69, 0x74, 0x68, 0x75, 0x62, 0x72, 0x69,
	...
	0x50, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x12, 0x1f,
	...
	0x46, 0x69, 0x6c, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x2b, 0x5a,
...
var file_githubridge_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
...
var file_githubridge_proto_depIdxs = []int32{
	...
	18, // 17: githubridge.GithubridgeService.AddLabel:output_type -> githubridge.AddLabelResponse
	20, // 18: githubridge.GithubridgeService.DeleteLabel:output_type -> githubridge.DeleteLabelResponse
	3,  // 19: githubridge.GithubridgeService.CreateIssue:output_type -> githubridge.CreateIssueResponse
	7,  // 20: githubridge.GithubridgeService.GetIssue:output_type -> githubridge.GetIssueResponse
	6,  // 21: githubridge.GithubridgeService.GetIssues:output_type -> githubridge.GetIssuesResponse
	9,  // 22: githubridge.GithubridgeService.CloseIssue:output_type -> githubridge.CloseIssueResponse
	11, // 23: githubridge.GithubridgeService.CommentOnIssue:output_type -> githubridge.CommentOnIssueResponse
	14, // 24: githubridge.GithubridgeService.GetComments:output_type -> githubridge.GetCommentsResponse
	16, // 25: githubridge.GithubridgeService.GetLabels:output_type -> githubridge.GetLabelsResponse
	23, // 26: githubridge.GithubridgeService.GetReleases:output_type -> githubridge.GetReleasesResponse
	25, // 27: githubridge.GithubridgeService.GetRepos:output_type -> githubridge.GetReposResponse
	27, // 28: githubridge.GithubridgeService.GetProjects:output_type -> githubridge.GetProjectsResponse
	29, // 29: githubridge.GithubridgeService.ListFiles:output_type -> githubridge.ListFilesResponse
