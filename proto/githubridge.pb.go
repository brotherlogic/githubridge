...
var file_githubridge_proto_rawDesc = []byte{
	...
	0x64, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x8c,
	0x05, 0x0a, 0x12, 0x47, 0x69, 0x74, 0x68, 0x75, 0x62, 0x72, 0x69, 0x64, 0x67, 0x65, 0x53, 0x65,
	...
	0x61, 0x62, 0x65, 0x6c, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x2b, 0x5a,
...
var file_githubridge_proto_goTypes = []interface{}{
	...
	(*AddLabelRequest)(nil),        // 16: githubridge.AddLabelRequest
	(*AddLabelResponse)(nil),       // 17: githubridge.AddLabelResponse
}
var file_githubridge_proto_depIdxs = []int32{
	...
	16, // 2: githubridge.GithubridgeService.AddLabel:input_type -> githubridge.AddLabelRequest
	1,  // 3: githubridge.GithubridgeService.CreateIssue:input_type -> githubridge.CreateIssueRequest
	3,  // 4: githubridge.GithubridgeService.GetIssue:input_type -> githubridge.GetIssueRequest
	4,  // 5: githubridge.GithubridgeService.GetIssues:input_type -> githubridge.GetIssuesRequest
	7,  // 6: githubridge.GithubridgeService.CloseIssue:input_type -> githubridge.CloseIssueRequest
	9,  // 7: githubridge.GithubridgeService.CommentOnIssue:input_type -> githubridge.CommentOnIssueRequest
	11, // 8: githubridge.GithubridgeService.GetComments:input_type -> githubridge.GetCommentsRequest
	14, // 9: githubridge.GithubridgeService.GetLabels:input_type -> githubridge.GetLabelsRequest
	17, // 10: githubridge.GithubridgeService.AddLabel:output_type -> githubridge.AddLabelResponse
	2,  // 11: githubridge.GithubridgeService.CreateIssue:output_type -> githubridge.CreateIssueResponse
	6,  // 12: githubridge.GithubridgeService.GetIssue:output_type -> githubridge.GetIssueResponse
	5,  // 13: githubridge.GithubridgeService.GetIssues:output_type -> githubridge.GetIssuesResponse
	8,  // 14: githubridge.GithubridgeService.CloseIssue:output_type -> githubridge.CloseIssueResponse
	10, // 15: githubridge.GithubridgeService.CommentOnIssue:output_type -> githubridge.CommentOnIssueResponse
	13, // 16: githubridge.GithubridgeService.GetComments:output_type -> githubridge.GetCommentsResponse
	15, // 17: githubridge.GithubridgeService.GetLabels:output_type -> githubridge.GetLabelsResponse
